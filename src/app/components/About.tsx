    ...
    <section id="heritage" style={{ background: "#f0ede8", overflow: "hidden" }}>
      ...
      >
        ...
        >
          ...
          >
            For over three decades, Evangel Collectibles has been Owerri's premier destination for
            authentic Igbo cultural heritage. We specialize in authentic coral beadwork, ceremonial
            regalia, traditional costumes, and now complete event solutions with catering and
            decoration services.
          </p>
          <p
            style={{
          ...
          >
            From bespoke bridal sets to chieftaincy regalia, cultural day rentals to career event
            attire — every piece is crafted with reverence for tradition and an eye for modern
            elegance.
          </p>
